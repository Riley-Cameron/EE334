...
unpack_oL EQU 0x14
unpack_oH EQU 0x15
CODE1 EQU 0x16 ;4 bytes 0x16-0x19
CODE_P EQU 0x1A ;2 bytes 0x1A-0x1B
guess_up EQU 0x1C ;4 bytes 0x1C-0x1F
...
;init variables and call subroutines
	...
	MOVWF TMR0H,a
	MOVWF TMR0L,a
	MOVLW b'10001000' ;timer control: ON,16bit,internal CLK,X,no prescaler
	MOVWF T0CON,a
